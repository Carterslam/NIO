...
public class SSLServer {  
    ...
    static String path = "D://MyEclipse//MyEclipse Professional 2014//binary//com.sun.java.jdk7.win32.x86_64_1.7.0.u45//bin//kserver.keystore";
    ...
    public void init() {  
        try {  
            ...
            ks.load(new FileInputStream(path), SERVER_KEY_STORE_PASSWORD.toCharArray());  
            tks.load(new FileInputStream(path), SERVER_TRUST_KEY_STORE_PASSWORD.toCharArray());  
...
//from http://blog.csdn.net/binyao02123202/article/details/7702989
